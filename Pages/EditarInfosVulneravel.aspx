<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/LoginCadastro.master" AutoEventWireup="true" CodeFile="EditarInfosVulneravel.aspx.cs" Inherits="Pages_EditarInfosVulneravel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <p class="mt-3">
                <strong>Atenção!</strong> você está editando os dados do(a) vulnerável <strong>
            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group mb-2">
                            <asp:TextBox ID="txtData" runat="server" CssClass="form-control" required placeholder="Data de Nascimento" />
                        </div>
                    </div>
                </div>
                <div class="row">
