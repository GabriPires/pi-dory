...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-8">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="col-7">
                            <asp:TextBox ID="txtDeficienciaMental" runat="server" CssClass="form-control form-control-lg" placeholder="Descreva aqui" required="true" />
                        </div>
                    </div>
                </div>
                    </div>
                <div class="col-12">
                    <div class="form-group ">
                        ...
                        <div class="col-7">
                            <asp:TextBox ID="txtDeficienciaFisica" runat="server" CssClass="form-control form-control-lg" placeholder="Descreva aqui" required="true" />
                        </div>
                    </div>
                    </div>
                </div>
            <div class="col-12">
                    <div class="form-group ">
                        ...
                        <div class="col-7">
                            <asp:TextBox ID="txtRestricaoAlimentar" runat="server" CssClass="form-control form-control-lg" placeholder="Descreva aqui" required="true" />
                        </div>
                    </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group ">
                        ...
                        <div class="col-7">
                            <asp:TextBox ID="txtRestricaoMedicamento" runat="server" CssClass="form-control form-control-lg" placeholder="Descreva aqui" required="true" />
                        </div>
                    </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="col-7">
                            <asp:TextBox ID="txtDoenca" runat="server" CssClass="form-control form-control-lg" placeholder="Descreva aqui" required="true" />
                        </div>
                    </div>
                    </div>
                </div>
        ...
        <div class="form-group">
            <div class="">
               <asp:Button ID="btnContinuaCadastroDesaparecido" runat="server" CssClass="btn btn-primary btn-cadastro text-white" Text="Realizar Cadastro" />
            </div>
        </div>
